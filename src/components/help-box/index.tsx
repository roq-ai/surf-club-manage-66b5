...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Club Member'];
  const customerRoles: string[] = ['Event Participant'];
  const tenantRoles: string[] = ['Club Member', 'Club Manager'];
  const addOns: string[] = ['chat', 'notifications'];
  const applicationName = `Surf Club Manager`;
